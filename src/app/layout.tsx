...
export const metadata: Metadata = {
  title: "SecureGuard - Enterprise Cybersecurity Protection",
  description: "Advanced AI-powered threat detection and enterprise security solutions protecting 5,000+ organizations. Real-time monitoring, incident response, and compliance.",
  keywords: "cybersecurity, threat detection, enterprise security, data protection, incident response",
  openGraph: {
    title: "SecureGuard - Enterprise Cybersecurity Protection",
    description: "Protect your organization with enterprise-grade cybersecurity solutions",
    type: "website",
    siteName: "SecureGuard"
  },
  robots: {
    index: true,
    follow: true
